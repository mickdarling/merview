...
test.describe('URL Resolution for Doc Navigation', () => {

    test.describe('isRelativeDocPath', () => {
        test('should recognize valid doc paths', async ({ page }) => {
            await page.goto('/');

            const results = await page.evaluate(() => {
                // Import dynamically since it's an ES module
        ...
        test('should reject invalid paths', async ({ page }) => {
            await page.goto('/');
        ...
        test('should be case-sensitive for docs/ prefix', async ({ page }) => {
            await page.goto('/');
    ...
    test.describe('Integration: Doc navigation', () => {
        ...
        test('should not load invalid doc paths', async ({ page }) => {
